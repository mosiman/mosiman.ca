"""
Django settings for mosiman project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'mosiman', 'templates'),
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    ...
    'parkingtoronto': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': os.path.join(BASE_DIR, 'parkingtoronto', 'allstreetsegs.db'),
    }
}
